...
public class ClientAsyncTask extends AsyncTask<Void, Void, String> {
    private final  int CONNECTION_TIMEOUT_MILLISECOND = 60000;
    ...
    protected String doInBackground(Void... voids){
        ...
        try {
            ...
            urlConnection.setConnectTimeout(CONNECTION_TIMEOUT_MILLISECOND);
            urlConnection.setReadTimeout(CONNECTION_TIMEOUT_MILLISECOND);
